                                  ...
                                  return Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: account.data.image == null ? Image.asset(
                                          ...
                                          width: ScreenUtil().setWidth(80), height: ScreenUtil().setHeight(80), fit: BoxFit.cover
                                        ),
                                      ),
                                      Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Container(
                                              width: ScreenUtil().setWidth(270),
                                              child: Text('${account.data.fullName}', style: textProfileBoldMini, maxLines: 1,)
                                            ),
                                            Container(
                                              padding: const EdgeInsets.only(top: 3),
                                              width: ScreenUtil().setWidth(270),
                                              child: Text('${account.data.phone}', style: textProfile,)
                                            ),
                                            Container(
                                              padding: const EdgeInsets.only(top: 1),
                                              width: ScreenUtil().setWidth(270),
                                              child: Text('${account.data.email}', style: textProfile,)
                                            )
                                          ],
                                        ),
                                      ),
                                      Container(
                                        ...
                                        child: TouchableOpacity(
                                          onTap: () async {
                                            final imageURL = EndPoint.baseURL+'storage/profile-images/'+account.data.image;
                                            final result = await Navigator.push(context, MaterialPageRoute(builder: (context) => EditProfile(image: imageURL, name: account.data.fullName, phone: account.data.phone, email: account.data.email,),));
                                            if (result == 'back') {
                                              await ApiCallsGetData().getData();
                                              setState(() {});
                                            }
                                          },
                                          child: Image.asset('assets/edit_svgrepo_com.png', width: ScreenUtil().setWidth(25), height: ScreenUtil().setHeight(25),)
                                        ),
                                      )
                                    ],
                                  );
