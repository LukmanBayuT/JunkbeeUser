...
GoogleSignIn _googleSignIn = GoogleSignIn(
  clientId: '359679760003-ekq8juiku5p1k5f386i19v7a7udph28f.apps.googleusercontent.com'
);
...
class _EditProfileState extends State<EditProfile> {
  ...
  updateData() async {
    ...
    final updateData = await http.put(
      ...
      body: json.encode({ 'full_name': nameController.text, 'phone': phoneController.text, 'email': emailController.text, 'address': 'Jln. Jrg Checkin' })
    );
  ...
  Widget build(BuildContext) {
    return ScreenUtilInit(
      ...
      builder: () => Scaffold(
        appBar: AppBar(
          title: Text('Edit Profile', style: textBodyProfile),
          centerTitle: true,
          ...
          actions: [
            Container(
              ...
              child: TouchableOpacity(
                onTap: () => updateData(),
                child: Text('Save', style: textProfileMediumWhite)
              )
            )
          ],
        ),
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: widget.image == null ? Image.asset(
                          ...
                          width: ScreenUtil().setWidth(110), height: ScreenUtil().setHeight(110),
                        ): Image.network(
                          '${widget.image}',
                          width: ScreenUtil().setWidth(110), height: ScreenUtil().setHeight(110), fit: BoxFit.cover
                        ),
                      ),
                      Positioned(
                        bottom: 0,
                        ...
                        child: TouchableOpacity(
                          ...
                          child: Container(
                            ...
                            child: Image.asset('assets/group_1666.png', width: ScreenUtil().setWidth(20), height: ScreenUtil().setHeight(20),)
                          )
                        )
                      )
                    ],
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        width: ScreenUtil().setWidth(342),
                        child: Text('Your Name', style: textProfile,),
                      ),
                      TextFormField(
                      ...
                      Container(
                        ...
                        width: ScreenUtil().setWidth(342),
                        child: Text('Mobile Number', style: textProfile,),
                      ),
                      TextFormField(
                      ...
                      Container(
                        padding: const EdgeInsets.only(top: 24),
                        width: ScreenUtil().setWidth(342),
                        child: Text('Email Address', style: textProfile,),
                      ),
                      TextFormField(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        width: ScreenUtil().setWidth(400),
                        child: Text('Linked Account', style: textProfileBold,),
                      ),
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: Image.asset('assets/group_1669.png')
                                ),
                                Container(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: Text('Facebook', style: textProfile,),
                                ),
                              ],
                            ),
                            FutureBuilder(
                              ...
                              builder: (context, AsyncSnapshot snapshot) {
                                ...
                                if (snapshot.connectionState == ConnectionState.done) {
                                  return Container(
                                    child: (editProfile.data.facebookId) == 'null' || (editProfile.data.facebookId) == null ?
                                      Transform.rotate(
                                        angle: 3.15,
                                        child: FlutterSwitch(
                          ...
                          children: [
                            Row(
                              children: [
                                Container(
                                  width: ScreenUtil().setWidth(40),
                                  child: Image.asset('assets/group_1670.png')
                                ),
                                Container(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: Text('Google', style: textProfile,),
                                ),
                              ],
                            ),
                            FutureBuilder(
