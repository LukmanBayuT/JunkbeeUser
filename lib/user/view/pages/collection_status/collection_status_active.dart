            ...
            FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.hasData) {
                                          ...
                                          children: [
                                            ...
                                            Container(
                                                ...
                                                child: const Text(
                                                  ...
                                                  style: TextStyle(fontWeight: FontWeight.w800, color: Color(0xFF707070)),
                                                ))
                                          ],
                                        )),
                                    Container(
                                    ...
                                    Container(
                                        ...
                                        child: Row(
                                          children: [
                                            const Text(
                                              'Pesanan dibuat : ',
                                              style: TextStyle(fontWeight: FontWeight.w500, color: Color(0xFFF8C503)),
                                            ),
                                            Text(
                                                '${collectiondata.data[index].createdAt}',
                                                style: const TextStyle(fontWeight: FontWeight.w800, color: Color(0xFFF8C503)))
                                          ],
                                        )),
                                    Container(
                                      ...
                                      child: const Text(
                                        ...
                                        style: TextStyle(fontWeight: FontWeight.w500, color: Color(0xFF707070)),
                                      ),
                                    ),
                                    ExpansionTile(
                                      title: const Text(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                ...
                                                style: const TextStyle(fontWeight: FontWeight.w500, color: Color(0xFF707070)),
                                              ),
                                            ),
                  ...
                  return const Center(child: SpinKitWave(size: 50, color: Colors.amber));
                }
              },
            ),
          ] else if (index == 1) ...[
