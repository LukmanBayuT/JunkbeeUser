                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              padding: const EdgeInsets.only(top: 2, bottom: 10),
                                              child: const Text('Mr. Joko - Beever', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Color(0xFF707070)),)
                                            ),
                                            const Text('How its going Miss?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF707070)), maxLines: 1)
                                          ],
                                        )
                                      ...
                                      Container(
                                        ...
                                        width: MediaQuery.of(context).size.width / 4.6,
                                        alignment: Alignment.topRight,
                                        child: const Text('Yesterday', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF707070)),)
                                      )
                                    ],
                                  )
                                )
