                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Image.asset('assets/group_1718.png', width: MediaQuery.of(context).size.width / 2)
                                                ),
                                                Container(
                                                  padding: const EdgeInsets.only(top: 14, bottom: 19),
                                                  child: Text('Do you enjoy using JunkBee?', style: bodyBodyBold),
                                                ),
                                                ...
                                                Container(
                                                  ...
                                                  child: ElevatedButton(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    padding: const EdgeInsets.only(top: 38),
                                                                    child: Image.asset('assets/group_1734.png', width: MediaQuery.of(context).size.width / 2)
                                                                  ),
                                                                  Container(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: const Text(
                                                                      ...
                                                                      style: bodyBody, textAlign: TextAlign.center
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: ElevatedButton(
                                                                      ...
                                                                      child: const Text('Give Rating', style: bodyBodyMini)
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  GestureDetector(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: const Text('No, Thanks', style: bodyBodySemi)
                                                                    )
                                                                  ),
                                                    ...
                                                    child: const Text('Yup, Love It!', style: bodyBodyMini)
                                                  ),
                                                ),
                                                const Padding(padding: EdgeInsets.only(bottom: 15)),
                                                GestureDetector(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: const Text('Not Really', style: bodyBodySemi)
                                                  )
                                                ),
                                                const Padding(padding: EdgeInsets.only(bottom: 30))
                                              ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          GestureDetector(
                                                            onTap: () => Navigator.of(context).pop(),
                                                            child: Image.asset('assets/group_2210.png', width: MediaQuery.of(context).size.width / 25)
                                                          )
                                                        ],
                                                      )
                                                    ),
                                                    Container(
                                                      ...
                                                      child: Text('Comeback Soon!', style: titleBodyLogout),
                                                    ),
                                                    Container(
