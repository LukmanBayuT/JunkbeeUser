              ...
              child: GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Image.asset('assets/group_1663.png', width: MediaQuery.of(context).size.width / 15),
                        Container(
                          padding: const EdgeInsets.only(left: 12),
                          child: const Text('Add Location', style: bodyBody),
                        )
                      ],
                    ),
                    const Icon(Icons.arrow_forward_ios_rounded, size: 15, color: Color(0xFF707070))
                  ],
                )
              ),
            ),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Image.asset('assets/group_1664.png', width: MediaQuery.of(context).size.width / 15),
                                Container(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: const [
                                      Text('Gudang Y, PT Amogus', style: bodyBodySemi),
                                      Text('Jl. Kaliwungu 3, Kendari', style: bodySlimBody)
                                    ],
                                  )
                                )
                              ],
                            ...
                            GestureDetector(
                              onTap: () => print('delete'),
                              child: Image.asset('assets/trash_svgrepo_com.png', width: MediaQuery.of(context).size.width / 20),
                            )
                          ],
                        ),
                      ),
