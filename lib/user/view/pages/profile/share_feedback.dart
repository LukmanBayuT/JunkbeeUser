        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/mask_group_30.png'), fit: BoxFit.cover)),
              ...
              child: Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text('Share Feedback', style: bodyBodyUserBold,),
                        ),
                        Container(
                          width: MediaQuery.of(context).size.width / 5,
                        )
                  ...
                  Container(
                    ...
                    child: const Text('Every Feedback helps. What can we improve on?', style: bodyBodyMini, textAlign: TextAlign.center),
                  )
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Image.asset('assets/group_241.png', width: MediaQuery.of(context).size.width / 2.5),
            ),
            Container(
              transform: Matrix4.translationValues(0, -75, 0),
              child: const Text('Beever', style: bodyBodySemi)
            ),
            Container(
            ...
            Container(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Send Feedback', style: onboardingGetStarted),
                  onPressed: () {
                    print('send feedback');
                  },
                ),
