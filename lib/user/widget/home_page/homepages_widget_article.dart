...
class ArticleJunkbee extends StatelessWidget {
  const ArticleJunkbee({Key? key}) : super(key: key);
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                child: Image.asset('assets_onboarding/1.png', width: MediaQuery.of(context).size.width / 5)),
              Positioned(
                top: MediaQuery.of(context).size.height / 15,
                left: MediaQuery.of(context).size.width / 20,
                child: const Text('What is Junkbee?', style: bodySlimBodyUser),
              ),
            ],
          ),
        ),
